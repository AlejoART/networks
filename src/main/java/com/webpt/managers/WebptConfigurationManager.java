...
public class WebptConfigurationManager {
	...
	/**
	 * getNodesList
	 * @param key - key to the nodes you want to retrieve (ie atf.databases.database)
	...
	{
		String key = "atf/customapplicationconfig/testdata-folder";
	...
	{
		String key = "atf/web/unexpected-alert-behaviour";
		return getStringEntry(key);
	}
    public String getGoogleUrl()
    {
    	String key = "atf/web/base-url/google";
    	return getStringEntry(key);
    }
    public String getBingUrl()
    {
    	String key = "atf/web/base-url/bing";
    	return getStringEntry(key);
    }
	...
	public String getGridUsername() {
		String key = "atf/desired-capabilities/grid-username";
		return getStringEntry(key);
	}
	public String getGridAccessKey() {
		String key = "atf/desired-capabilities/grid-accesskey";
		return getStringEntry(key);
	}
	public String getSauceConnectTunnelName() {
		String key = "atf/desired-capabilities/sauceConnectTunnelName";
		return getStringEntry(key);
	}
	/**
	...
	public String getGridType() {
		String key = "atf/desired-capabilities/grid-type";
		return getStringEntry(key);
	}
    ...
    public List<String> getChromeArgs() {
    	String key = "atf/desired-capabilities/chrome/chrome-options/args";
    	return getListEntry(key);
    }
    public String getChromeBinary() {
    	String key = "atf/desired-capabilities/chrome/chrome-options/binary";
    	return getStringEntry(key);
    }
    public List<String> getChromeExtensions() {
    	String key = "atf/desired-capabilities/chrome/chrome-options/extensions";
    	return getListEntry(key);
    }
	...
	public String getGeckoDriverLocation() {
		String key = "atf/desired-capabilities/firefox/webdriver-gecko-location";
		return getStringEntry(key);
	}
    // INTERNET EXPLORER
	...
	/************* DATABASE *********************************************************/
	/********************************************************************************/
	public List<HierarchicalConfiguration> getDataSources()
	{
		String key = "atf.databases.database";
		return getNodesList(key);
	}
